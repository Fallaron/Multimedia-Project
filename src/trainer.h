...
void predict_pedestrian(double ** featArray, std::vector<int> feat_dims, std::string svm_path);
...
std::vector<std::vector<float>>  predict_pedestrian(double ** featArray, std::vector<int> feat_dims, std::string svm_path, int pos_x, int pos_y, int scale, bool &found_Person);